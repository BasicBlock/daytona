...
func NewRunner(id string, cpu float32, memory float32, disk float32, target string, name string, state RunnerState, unschedulable bool, tags []string, createdAt string, updatedAt string, version string, apiVersion string) *Runner {
	this := Runner{}
	this.Id = id
	this.Cpu = cpu
	this.Memory = memory
