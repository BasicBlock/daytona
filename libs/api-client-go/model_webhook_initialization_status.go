...
func NewWebhookInitializationStatus(applicationId string, svixApplicationId NullableString, lastError NullableString, retryCount float32, createdAt string, updatedAt string) *WebhookInitializationStatus {
...
func (o *WebhookInitializationStatus) GetApplicationId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *WebhookInitializationStatus) GetApplicationIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebhookInitializationStatus) SetApplicationId(v string) {
	o.ApplicationId = v
}
